                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                ...
                                                <tbody>
                                                    @include('call_center.partials.boosting-orders')
                                                </tbody>
                                            </table>
                                        </div>
                                    </div> <!-- end col -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                ...
                                                <tbody>
                                                    @include('call_center.partials.design-orders')
                                                </tbody>
                                            </table>
                                        </div>
                                    </div> <!-- end col -->
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                ...
                                                <tbody>
                                                    @include('call_center.partials.video-orders')
                                                </tbody>
    ...
    <script>
        ...
        document.addEventListener('scroll', function () {
            ...
            if (!isLoading && bottom) {
                ...
                if (['basictab1', 'basictab2', 'basictab3'].includes(activeTab)) {
                    const type = activeTab === 'basictab1' ? 'boosting' :
                        activeTab === 'basictab2' ? 'designs' : 'video';
                    loadMore(type);
                }
            }
        });
        ...
        function loadMore(type) {
            isLoading = true;
            pages[type]++;
            const tableBody = document.querySelector(`#basictab${type === 'boosting' ? '1' : type === 'designs' ? '2' : '3'} table tbody`);
