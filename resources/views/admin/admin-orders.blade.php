                                                            ...
                                                            @if ($order->ps == '1' && $order->order_type == 'boosting')
                                                                ...
                                                                <tr class="fw-semibold" data-order-id="{{ $order->id }}">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" name="package_amtold" class="form-control edit-mode"
                                                                            value="{{ $order->package_amt }}" hidden>
                                                                        <input type="text" name="package_amt" class="form-control edit-mode"
                                                                            value="{{ $order->package_amt }}">
                                                                    </td>
                                                                    <td>
                                                                        <span class="display-mode">{{ $order->service }}</span>
                                                                        <input type="text" name="serviceold" class="form-control edit-mode"
                                                                            value="{{ $order->service }}" hidden>
                                                                        <input type="text" name="service" class="form-control edit-mode"
                                                                            value="{{ $order->service }}">
                                                                    </td>
                                                                    <td>
                                                                        <span class="display-mode">{{ $order->tax }}</span>
                                                                        <input type="text" name="taxold" class="form-control edit-mode"
                                                                        value="{{ $order->tax }}" hidden>
                                                            ...
                                                            <tr data-order-id="{{ $order->id }}">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select name="designer_id" class="form-select edit-mode">
                                                                        ...
                                                                        @foreach ($users as $user)
                                                                            @if($user->role == 'dsg')
                                                                                <option value="{{ $user->id }}" @if($order->designer_id == $user->id) selected
                                                                                @endif>{{ $user->name }}</option>
                                                                            @endif
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input type="text" name="amountold" class="form-control edit-mode" value="{{ $order->amount }}" hidden>
                                                                </td>
                                                                <td>
                                                                    <span>{{$order->advance}}</span>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <button type="button" class="btn btn-primary edit-btn display-mode">Edit</button>
                                                                    <button type="button" class="btn btn-primary done-btnd edit-mode">Done</button>
                                                                </td>
                                                            </form>
                                                            </tr>
                                                        ...
                                                        <tr data-order-id="{{ $order->id }}">
                                                            <form action="/admin/orders/updateV/{{ $order->id }}" method="post">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input type="text" name="video_time" value="{{ $order->video_time }}" hidden>
                                                                </td>
                                                                <td>
                                                                    <span class="badge fs-5 display-mode 
                                                                        @if($order->work_status == 'done') bg-primary
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select name="editor_id" class="form-select edit-mode">
                                                                        ...
                                                                        @foreach ($users as $user)
                                                                            @if($user->role == 'vde')
                                                                                <option value="{{ $user->id }}" @if($order->editor_id == $user->id) selected
                                                                                @endif>{{ $user->name }}</option>
                                                                            @endif
                                                                        @endforeach
                                                                    </select>
