        ...
        <tr class="fw-semibold" data-order-id="{{ $order->id }}" data-add-acc="{{ $order->add_acc }}">
            <form action="/admin/orders/updateB/{{ $order->id }}" method="post">
                ...
                <td>
                    ...
                    <input type="text" name="package_amtold" class="form-control edit-mode" value="{{ $order->package_amt }}"
                        hidden>
                    <input type="text" name="package_amt" class="form-control edit-mode" value="{{ $order->package_amt }}">
                </td>
                <td>
                    <span class="display-mode">{{ $order->service }}</span>
                    <input type="text" name="serviceold" class="form-control edit-mode" value="{{ $order->service }}" hidden>
                    <input type="text" name="service" class="form-control edit-mode" value="{{ $order->service }}">
                </td>
                <td>
                    <span class="display-mode">{{ $order->tax }}</span>
                    <input type="text" name="taxold" class="form-control edit-mode" value="{{ $order->tax }}" hidden>
                    <input type="text" name="tax" class="form-control edit-mode" value="{{ $order->tax }}">
                </td>
                <td>
                ...
                <td style="width: 150px; max-width: 150px; white-space: normal; word-wrap: break-word;">
                    ...
                    <input type="text" name="details" class="form-control edit-mode" style="width: 50px;"
                        value="{{ $order->details }}">
                </td>
                <td>
                    ...
                    @endif
                    <input type="text" name="add_acc_id" class="form-control edit-mode" value="{{ $order->add_acc_id }}">
                </td>
