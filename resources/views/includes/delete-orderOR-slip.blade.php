...
<!-- Payment Slips Modal -->
<div class="modal fade" id="deleteorderORslip" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Delete Slips Other Orders</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="/delete/slip/or" method="post" enctype="multipart/form-data">
                @csrf
...
$(document).ready(function() {
  ...
  $('#deleteorderORslip').on('shown.bs-modal shown.bs.modal', function () {
    $('#invdeleteor').select2({
      dropdownParent: $('#deleteorderORslip'),
